    ...
    <div className="bg-white mt-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
        ...
        <div className="flex flex-col items-center bg-gray-100 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-center mt-2 text-gray-500">We’re here to help.</p>
          <a
        ...
        <div className="flex flex-col items-center bg-gray-100 p-6 rounded-lg shadow-lg">
          ...
          <p className="text-center mt-2 text-gray-500">Visit our office HQ.</p>
          <a
      ...
      <div className="max-w-4xl mx-auto mt-16 px-4">
        ...
        >
          ...
          >
            <p className="text-base text-gray-600 font-medium">
              Our support team is available from 09:00AM to 07:00PM, Saturday to
              Wednesday.
            </p>
          </Panel>
          <Panel
